...
namespace BugTrackerPro.Controllers
{
    public class TicketStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] TicketStatus ticketStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] TicketStatus ticketStatus)
        {
