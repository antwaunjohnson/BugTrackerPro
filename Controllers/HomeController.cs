...
using BugTrackerPro.Models.ChartModels;
...
public class HomeController : Controller
{
    ...
    public HomeController(ILogger<HomeController> logger, IBTProCompanyInfoService companyInfoService, IBTProProjectService projectService)
    {
        _logger = logger;
    ...
    public async Task<JsonResult> GglProjectPriority()
    {
        ...
        foreach (string priority in Enum.GetNames(typeof(BTProProjectPriority)))
        {
