    ...
    public partial class Database_Refresh : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BTProUserProject", x => new { x.MembersId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_BTProUserProject_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BTProUserProject_Projects_ProjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BTProUserProject_ProjectsId",
                table: "BTProUserProject",
                column: "ProjectsId");
