        ...
        try
        {
            IList<Ticket> tickets = new List<Ticket>() {
                                ...
                                new Ticket() {Title = "Movie Ticket 20", Description = "Ticket details for movie ticket 20", Created = DateTimeOffset.Now, ProjectId = movieId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                      //ADDRESS BOOK
                                new Ticket() {Title = "Address Book Ticket 1", Description = "Ticket details for address book ticket 1", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 2", Description = "Ticket details for address book ticket 2", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusDev, TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 3", Description = "Ticket details for address book ticket 3", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 4", Description = "Ticket details for address book ticket 4", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Address Book Ticket 5", Description = "Ticket details for address book ticket 5", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusDev,  TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 6", Description = "Ticket details for address book ticket 6", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew,  TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 7", Description = "Ticket details for address book ticket 7", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 8", Description = "Ticket details for address book ticket 8", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusDev,  TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Address Book Ticket 9", Description = "Ticket details for address book ticket 9", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew,  TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 10", Description = "Ticket details for address book ticket 10", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 11", Description = "Ticket details for address book ticket 11", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusDev,  TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 12", Description = "Ticket details for address book ticket 12", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew,  TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Address Book Ticket 13", Description = "Ticket details for address book ticket 13", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 14", Description = "Ticket details for address book ticket 14", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusDev,  TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 15", Description = "Ticket details for address book ticket 15", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew,  TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 16", Description = "Ticket details for address book ticket 16", Created = DateTimeOffset.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
